$(document).ready(function(){
    $('#slide_bg>li:nth-child(2)').delay(1300).fadeIn(490,function(){
        $('#slide_bg>li:nth-child(3)').delay(1300).fadeIn(490,function(){
        $('#slide_bg>li:nth-child(4)').delay(1300).fadeIn(490,function(){
        $('#slide_bg>li:nth-child(2)').fadeOut(500)
        $('#slide_bg>li:nth-child(3)').fadeOut(500)
        $('#slide_bg>li:nth-child(4)').delay(1300).fadeOut(500)
        $('#slide_bg>li:nth-child(1)').delay(1300).fadeIn(500)
        })
        })
        })
